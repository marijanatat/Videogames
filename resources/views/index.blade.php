...
<div class="container mx-auto px-4 pb-16">
    ...
    <div class="popular games text-sm grid grid-cols-6 gap-12 border-b border-gray-800">
        ...
        <div class="game mt-8">
            <div class="relative inline-block">
                <a href=""><img src="/images/cyberpunk.jpg " class="hover:opacity-75 transition ease-in-out duration-150"
                        alt="game cover"></a>
                <div class="absolute bottom-0 right-0 w-16 h-16 bg-gray-800 rounded-full"
                    style="right:-20px;bottom:-20px">
                    <div class="font-semibold text-xs  h-full flex justify-center items-center">80%</div>
    ...
    <div class="flex my-10">
           ...
           <div class="recently review container space-y-12 mt-8">
               <div class="game flex shadow-lg bg-gray-800 rounded-lg px-6 py-6">
                    <div class="relative flex-none">
                        <a href=""><img src="/images/doom.jpg " class=" w-48 hover:opacity-75 transition ease-in-out duration-150"
                            alt="game cover"></a>
                    ...
                    <div class="ml-12">
                        <a href="" class="block text-lg  font-semibold leading-tight hover:text-gray-400 mt-4">Doom new</a>
                         <div class="text-gray-400 mt-1">PS4</div>
                         <div class="mt-6 text-gray-400 text-base">Developed by id Software, DOOM Eternal is the direct sequel to DOOM (2016). Experience the ultimate combination of speed and power with the next leap in push-forward, first-person combat.

                            As the DOOM Slayer, return to take your vengeance against the forces of Hell. Set to an all-new pulse pounding soundtrack composed by Mick Gordon, fight across dimensions as you slay new and classic demons with powerful new weapons and abilities.</div>
                    </div>
                </div>

                <div class="game flex shadow-lg bg-gray-800 rounded-lg px-6 py-6">
                    <div class="relative flex-none">
                        <a href=""><img src="/images/animalcrossing.jpg " class=" w-48 hover:opacity-75 transition ease-in-out duration-150"
                            alt="game cover"></a>
                        <div class="absolute bottom-0 right-0 w-16 h-16 bg-gray-900 rounded-full"
                            style="right:-20px;bottom:-20px">
                            <div class="font-semibold text-xs  h-full flex justify-center items-center">80%</div>
                    ...
                    <div class="ml-12">
                        <a href="" class="block text-lg  font-semibold leading-tight hover:text-gray-400 mt-4">Animal new</a>
                         <div class="text-gray-400 mt-1">Nintendo</div>
                         <div class="mt-6 text-gray-400 text-base">Time passes in Animal Crossing in real-time, as the month, day, season, and time of day matches that of the player's. Holiday seasons come and go in Animal Crossing, just as they would in the real world. Experience the freedom to fish, decorate your house, go bug catching, garden, write letters, and even play original Nintendo NES games in this imaginative, and addictive game.</div>
                    </div>
                </div>
        ...
        <div class="most anticipated w-1/4">
            ...
            <div class="most antic container space-y-10 mt-8">
                <div class="game flex">
                     <a href=""><img src="/images/doom.jpg " class=" w-16 hover:opacity-75 transition ease-in-out duration-150"
                        alt="game cover"></a>
                        <div class="ml-4">
