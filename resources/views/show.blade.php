...
<div class="container mx-auto px-4">
    <div class="game detail flex flex-col lg:flex-row border-b border-gray-800 pb-12">
        ...
        <div class="lg:ml-12 lg:mr-64">
            ...
            <div x-data="{isOpen:false}">
                <div class="mt-12 ">
                     <button  @click="isOpen=true" class=" bg-blue-500 flex font-semibold text-white px-4 py-4 hover:bg-blue-600 rounded transition ease-in-out duration-150">
                ...
                {{-- <a href="{{$game['trailer']}}" class="inline-flex bg-blue-500 flex font-semibold text-white px-4 py-4 hover:bg-blue-600 rounded transition ease-in-out duration-150">
                    <svg class="w-6 fill-current" viewBox="0 0 24 24"><path d="M0 0h24v24H0z" fill="none"></path><path d="M10 16.5l6-4.5-6-4.5v9zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"></path></svg>
                    <span class="ml-2">Play Trailer</span>
                   </a> --}}
                </div>
                            ...
                            <div class="bg-gray-900 rounded">
                                ...
                                <div class="modal-body px-8 py-8">
                                    <div class="responsive-container overflow-hidden relative" style="padding-top: 56.25%">
                                        <iframe class="responsive-iframe absolute top-0 left-0 w-full h-full" src="https://www.youtube.com/embed/{{ $game['videos'][0]['video_id'] }}" style="border:0;" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="images container border-b border-gray-800 pb-12 mt-8">
        ...
        <div class="grid grid-col-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mt-8">
            @if(property_exists('screenshots',$game))
